...
export default function ProductDetailPage() {
  ...
  const lat = product.farmer?.profile?.latitude
  const lng = product.farmer?.profile?.longitude
  ...
  const fallbackLocation = `${product.farmer?.profile?.kebele?.name || ''},
  ${product.farmer?.profile?.kebele?.woreda?.name || ''},
  ${product.farmer?.profile?.kebele?.woreda?.zone?.name || ''},
  ${product.farmer?.profile?.kebele?.woreda?.zone?.region?.name || ''},
  ${product.city || ''}`

  const mapQuery = hasCoordinates ? `${lat},${lng}` : fallbackLocation
      ...
      <main className="flex-1 pt-20 pb-16 px-4 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4 capitalize">{product.name}</h1>
            ...
            <div className="mb-3">
              <span className="text-3xl font-bold text-emerald-600">ETB {product.price}</span>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-800">{product.amount} kg</p>
                </div>
